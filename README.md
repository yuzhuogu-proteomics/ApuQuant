...
# Demo dataset
The demo dataset has been deposited to the ProteomeXchange Consortium (https://proteomecentral.proteomexchange.org) via the iProX partner repository. You can use the following link https://www.iprox.cn/page/project.html?id=IPX0016038000 to download Demo dataset for testing and using ApuQuant. 
